...
v.mozPreservesPitch = v.webkitPreservesPitch = v.preservePitch = !p;
  ...
  for file in files:
      ...
      judul = judul + "\n" + "\n"
      judul = judul + '    <source src="/kajian-ufa/tematik/Audio%20-%20Tematik/{}" type="audio/mpeg">'.format(file.replace(" ", "%20"))
      judul = judul + "\n"
      judul = judul + "    </audio>"
      judul = judul + "\n\n"
      print(judul)
      file1 = open("../tematik/index.md", "a")
      file1.write(judul)
      file1.close()
